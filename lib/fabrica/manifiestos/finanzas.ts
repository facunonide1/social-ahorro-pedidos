...
export const MANIFIESTO_FINANZAS: Manifiesto = {
  ...
  configurable: [
    { clave: 'dias_aviso_vencimiento', etiqueta: 'Días de anticipación para avisar un vencimiento', tipo: 'numero', default: 7 },
    { clave: 'maneja_cheques', etiqueta: 'Opera con valores a fecha', tipo: 'booleano', default: true },
    { clave: 'caja_por_turno', etiqueta: 'La caja se abre y cierra por turno', tipo: 'booleano', default: true },
    { clave: 'concilia_banco', etiqueta: 'Concilia contra el extracto bancario', tipo: 'booleano', default: true },
  ],
